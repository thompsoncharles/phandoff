...
**Current state:** One Bitcoin strategy candidate moved from backtesting into paper observation. Live trading is disabled.

---

## 1. Project Overview

This project is a Bitcoin quantitative research and automation system. The current version is not a live trading bot and does not claim live profitability. It is a paper observation workflow designed to test whether a backtested daily BTC candidate can hold up in forward observation.
...
The current paper observation candidate is a daily BTC strategy selected by walk forward testing.
...
The candidate was selected because it passed the project's promotion rules in historical walk forward testing. It is not treated as proven. Paper observation exists to test whether the historical behavior persists.
...
Rejected or not promoted experiments included:
